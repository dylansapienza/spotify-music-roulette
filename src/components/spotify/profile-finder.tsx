...
import { SpotifyInstructionsModal } from './spotify-instructions-modal';
    ...
    <>
      <div className="space-y-4">
        <div className="space-y-2">
          <Input
            placeholder="Username or paste profile link"
            value={usernameInput}
          ...
          <p className="text-white/40 text-xs px-1">
            e.g. <span className="text-white/60">johnsmith</span> or <span className="text-white/60">open.spotify.com/user/...</span>
          </p>
        </div>
